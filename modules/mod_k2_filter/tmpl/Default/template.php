...
<div id="K2FilterBox<?php echo $module->id; ?>" class="K2FilterBlock default <?php echo $params->get('moduleclass_sfx'); ?><?php if($cols == "0") echo ' k2filter-responsive'; ?>">
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_k2&view=itemlist&task=filter&Itemid=102'); ?>" name="K2Filter<?php echo $module->id; ?>" method="get">
...
<div class="buttons">
	...
	<button  class="btn submit-search <?php echo $moduleclass_sfx; ?>" type="submit">
