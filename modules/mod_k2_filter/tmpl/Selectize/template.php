...
if($_REQUEST['option'] == 'com_k2'){
	...
	switch($catid){
	  case LIFE_INSURANCE_ITEM:
	  $type_insurance = 'insurance';
	  break;
	  case LIFE_HEALTH_INSURANCE_ITEM:
	  $type_insurance = 'health';
	  break;
	  case LIFE_TRAVEL_INSURANCE_ITEM:
	  $type_insurance = 'travel';
	  break;
	  case LIFE_CAR_INSURANCE_ITEM:
	  $type_insurance = 'car';
	  break;
	  case LIFE_HOME_INSURANCE_ITEM:
	  $type_insurance = 'home';
	  break;
	  case LIFE_CRITICAL_ILLNESS_INSURANCE_ITEM:
...
?>
			<div class="search-reset">
				<div class="buttons">
					<?php if ($button):?>
					<input type="submit" onclick="return checkFormK2('<?php echo $type_insurance; ?>')" value="<?php echo $button_text; ?>" class="btn btn-primary button submit <?php echo $moduleclass_sfx; ?>" />
					<?php endif; ?>
	...
	<input type="hidden" name="catid" value="<?php echo $_REQUEST['id'] ?>" />
