...
<?php if($params->get('itemImageURL')): ?>
<div class="k2IntroImage">
    <img src="<?php echo JURI::root().$params->get('itemImageURL') ?>" />
</div>
<?php endif; ?>
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
    ...
    <ul>
        ...
        <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
            ...
            <div class="Category-K2">[<span class="itemCategory-k2"><?php echo $item->categoryname; ?></span>]</div>
