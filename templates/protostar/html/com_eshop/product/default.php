...
$categoryId = EshopHelper::getProductCategory($this->item->id);
?>
    <script src="<?php echo JUri::base(true); ?>/components/com_eshop/assets/colorbox/jquery.colorbox.js"
            type="text/javascript"></script>
    <script src="<?php echo JUri::base(true); ?>/components/com_eshop/assets/js/slick.js"
            type="text/javascript"></script>
    <script src="<?php echo JUri::base(true); ?>/components/com_eshop/assets/js/eshop-pagination.js"
            type="text/javascript"></script>
<?php
if (EshopHelper::getConfigValue('view_image') == 'zoom') {
    ?>
    <script src="<?php echo JUri::base(true); ?>/components/com_eshop/assets/js/jquery.jqzoom-core.js"
            type="text/javascript"></script>
    ...
    <div class="<?php echo $rowFluidClass; ?>">
        <div class="<?php echo $span6Class; ?> eshop-pre-nav">
            ...
            if (is_object($this->productsNavigation[0])) {
                ?>
                <a class="<?php echo $pullLeftClass; ?>"
                   href="<?php echo JRoute::_(EshopRoute::getProductRoute($this->productsNavigation[0]->id, isset($this->productsNavigation[0]->category_id) ? $this->productsNavigation[0]->category_id : EshopHelper::getProductCategory($this->productsNavigation[0]->id))); ?>"
        ...
        <div class="<?php echo $span6Class; ?> eshop-next-nav">
            ...
            if (is_object($this->productsNavigation[1])) {
                ?>
                <a class="<?php echo $pullRightClass; ?>"
                   href="<?php echo JRoute::_(EshopRoute::getProductRoute($this->productsNavigation[1]->id, isset($this->productsNavigation[1]->category_id) ? $this->productsNavigation[1]->category_id : EshopHelper::getProductCategory($this->productsNavigation[1]->id))); ?>"
                   title="<?php echo $this->productsNavigation[1]->product_page_title != '' ? $this->productsNavigation[1]->product_page_title : $this->productsNavigation[1]->product_name; ?>">
    ...
    <div itemscope itemtype="http://schema.org/Product" style="display: none;">
        ...
        if (EshopHelper::getConfigValue('allow_reviews')) {
            ...
            <span itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
				<span itemprop="ratingValue"><img
                            src="components/com_eshop/assets/images/stars-<?php echo round(EshopHelper::getProductRating($this->item->id)); ?>.png"/></span> based on <span
                        itemprop="reviewCount"><?php echo count($this->productReviews); ?></span> reviews
			</span>
            <?php
        }
        ?>
    ...
    <div class="product-info">
        <div class="<?php echo $rowFluidClass; ?>">
            <div class="<?php echo $span6Class; ?>">
                ...
                if (EshopHelper::getConfigValue('view_image') == 'zoom') {
                    ...
                    <div class="image <?php echo $imgPolaroid; ?>" id="main-image-area">
                        <a href="<?php echo str_replace(array('/resized/', '-500x500.'), array('/', '.'), $this->item->popup_image); ?>"
                           class="product-image-zoom" rel="product-thumbnails"
                           title="<?php echo $this->item->product_name; ?>">
                            <?php
                            if (count($this->labels)) {
                                for ($i = 0; $n = count($this->labels), $i < $n; $i++) {
                                    ...
                                    if ($label->enable_image && $label->label_image) {
                                        ...
                                        ?>
                                        <span class="<?php echo $label->label_style; ?> <?php echo $label->label_position; ?> small-db"
                            ...
                            ?>
                            <img style="width: 100%;" src="<?php echo str_replace(array('/resized/', '-500x500.'), array('/', '.'), $this->item->popup_image); ?>"
                                 title="<?php echo $this->item->product_page_title != '' ? $this->item->product_page_title : $this->item->product_name; ?>"
                                 alt="<?php echo $this->item->product_alt_image != '' ? $this->item->product_alt_image : $this->item->product_name; ?>"/>
                        </a>
                    </div>
                    <?php
                        ...
                        <div class="image-additional">
                            <div>
                                <a class="zoomThumbActive" href="javascript:void(0);"
                                   rel="{gallery: 'product-thumbnails', smallimage: '<?php echo $this->item->thumb_image; ?>',largeimage: '<?php echo $this->item->popup_image; ?>'}">
                            ...
                            for ($i = 0; $n = count($this->productImages), $i < $n; $i++) {
                                ...
                                <div>
                                    <a href="javascript:void(0);"
                                       rel="{gallery: 'product-thumbnails', smallimage: '<?php echo $this->productImages[$i]->thumb_image; ?>',largeimage: '<?php echo $this->productImages[$i]->popup_image; ?>'}">
                    ...
                    <div class="image <?php echo $imgPolaroid; ?>" id="main-image-area">
                        <a class="product-image" href="<?php echo $this->item->popup_image; ?>">
                            ...
                            ?>
                            <img src="<?php echo $this->item->thumb_image; ?>"
                                 title="<?php echo $this->item->product_page_title != '' ? $this->item->product_page_title : $this->item->product_name; ?>"
                                 alt="<?php echo $this->item->product_alt_image != '' ? $this->item->product_alt_image : $this->item->product_name; ?>"/>
                        </a>
                    </div>
                            ...
                            for ($i = 0; $n = count($this->productImages), $i < $n; $i++) {
                                ...
                                <div>
                                    <a class="product-image"
                                       href="<?php echo $this->productImages[$i]->popup_image; ?>">
                                        <img src="<?php echo $this->productImages[$i]->small_thumb_image; ?>"/>
                                    </a>
                                </div>
                                <?php
            ...
            <div class="<?php echo $span6Class; ?>">
                ...
                <?php if (EshopHelper::getConfigValue('show_sku')) {
                    ?>
                ...
                ?>
                    <!-- <b>Thương hiệu</b>: <?php echo $this->manufacturer->manufacturer_name; ?> -->
                <?php
                }
                ?>
                <?php
                if (EshopHelper::getConfigValue('show_product_weight')) {
                    ...
                    <div class="product-weight">
                        ...
                        <span><?php echo  ucfirst(EshopHelper::getWeightUnitName($this->item->product_weight_id, JFactory::getLanguage()->getTag())); ?></span>
                    </div>
                <?php
                }
                ?>
                <div class="short_desc"><?php echo $this->item->product_short_desc; ?></div>
                <?php
                        ...
                        <div class="product-desc">
                            ...
                            if (EshopHelper::getConfigValue('show_product_weight')) {
                                ...
                                <!-- <div class="product-weight">
                                    ...
                                    <span><?php echo number_format($this->item->product_weight, 0) . EshopHelper::getWeightUnit($this->item->product_weight_id, JFactory::getLanguage()->getTag()); ?></span>
                                </div> -->
                                <?php
                            }
                            ...
                            if (EshopHelper::getConfigValue('show_product_tags') && count($this->productTags)) {
                                ...
                                <div class="product-tags">
                                    ...
                                    for ($i = 0; $n = count($this->productTags), $i < $n; $i++) {
                                        ...
                                        ?>
                                        <a href="<?php echo $searchTagLink; ?>"
                                           title="<?php echo $tagName; ?>"><?php echo $tagName; ?></a>
                                        <?php
                                        if ($i < ($n - 1))
                                            echo ", ";
                                    }
                            ...
                            if (EshopHelper::getConfigValue('show_product_attachments') && count($this->productAttachments) > 0) {
                                ...
                                <div class="product-attachments">
                                    ...
                                    for ($i = 0; $n = count($this->productAttachments), $i < $n; $i++) {
                                        ...
                                        ?>
                                        -
                                        <a href="<?php echo JURI::root() . 'media/com_eshop/attachments/' . $productAttachment; ?>"
                                           title="<?php echo $productAttachment; ?>"
                                           target="_blank"><?php echo $productAttachment; ?></a>
                                        <br/>
                                    <?php } ?>
								</span>
                                </div>
                        ...
                        <h2>
                            <strong>
                                ...
                                if ($productPriceArray['salePrice'] >= 0) {
                                    ...
                                    ?>
                                    <span class="price"><?php echo $this->currency->format($this->tax->calculate($productPriceArray['basePrice'], $this->item->product_taxclass_id, EshopHelper::getConfigValue('tax'))); ?><span class="weight"> /  <?php  echo EshopHelper::getWeightUnitName($this->item->product_weight_id, JFactory::getLanguage()->getTag()) ; ?></span></span>
                                    <?php
                                }
                                ?>
                            </strong><br/>
                ...
                if ($this->item->product_call_for_price) {
                    ...
                    <div class="product-price">
                        ...
                        : <?php echo EshopHelper::getConfigValue('telephone'); ?>
                    </div>
                    <?php
                }
                ...
                $limitArea = false;
                if ($location != 50) {
                    $limitArea = SUtil::checkLimitArea($this->item->id);
                }

                if ($limitArea):?>
                    <div class="limit_shipping">Sản phẩm tạm thời chưa giao hàng tới khu vực của bạn.</div>
                <?php else: ?>
                    ...
                    <div class="product-cart clearfix">
                      ...
                      if ($this->item->product_quantity <= 0 ) {
                          ?>
                          <p style="color:red">
                            Sản phẩm hết hàng. Vui lòng quay lại sau!
                          </p>
                          <?php
                      }
                       ?>
                        ...
                        if (EshopHelper::isCartMode($this->item) || EshopHelper::isQuoteMode($this->item)) {
                            ...
                            if (EshopHelper::getConfigValue('show_quantity_box_in_product_page')) {
                                ...
                                ?>
                                <label class="label-quantity"><?php echo JText::_('ESHOP_QTY'); ?>:</label>
                                <div class="eshop-quantity">
                                    <a class="item spin-down" id="<?php echo $this->item->id; ?>" data="down">-</a>
                                    <input type="text" class="item eshop-quantity-value"
                                           id="quantity_<?php echo $this->item->id; ?>" name="quantity"
                                           value="<?php echo EshopHelper::getConfigValue('start_quantity_number', '1'); ?>"/>
                                    <a class="item spin-up" id="<?php echo $this->item->id; ?>" data="up">+</a>
                                    <input type="hidden" id="quantity_step_<?php echo $this->item->id; ?>"
                                           name="quantity_step"
                                           value="<?php echo EshopHelper::getConfigValue('quantity_step', '1'); ?>"/>
                                </div>
                                <?php
                            }
                            if (EshopHelper::isCartMode($this->item)) {
                                ?>
                                <button id="add-to-cart" class="<?php echo $btnClass; ?>" type="button">
                            ...
                            if (EshopHelper::isQuoteMode($this->item)) {
                                ?>
                                <button id="add-to-quote" class="<?php echo $btnClass; ?> btn-primary"
                                        type="button"><?php echo JText::_('ESHOP_ADD_TO_QUOTE'); ?></button>
                                <?php
                            }
                            ?>
                            <?php
                    ...
                    if (($this->item->product_quantity <= 0 && EshopHelper::getConfigValue('allow_notify') && !EshopHelper::getConfigValue('stock_checkout')) || EshopHelper::getConfigValue('allow_wishlist') || EshopHelper::getConfigValue('allow_compare') || EshopHelper::getConfigValue('allow_ask_question') || EshopHelper::getConfigValue('allow_download_pdf_product') || EshopHelper::getConfigValue('allow_email_to_a_friend')) {
                        ?>
                        <div class="<?php echo $span4Class; ?> col-xs-12">
                            <?php
                            if ($this->item->product_quantity <= 0 && EshopHelper::getConfigValue('allow_notify') && !EshopHelper::getConfigValue('stock_checkout')) {
                                ...
                                <p><a style="cursor: pointer;"
                                      onclick="makeNotify(<?php echo $this->item->id; ?>, '<?php echo EshopHelper::getSiteUrl(); ?>', '<?php echo EshopHelper::getAttachedLangLink(); ?>')"><?php echo JText::_('ESHOP_PRODUCT_NOTIFY'); ?></a>
                                </p>
                                <?php
                            }
                            ...
                            if (EshopHelper::getConfigValue('allow_wishlist')) {
                                ...
                                <i class="fa fa-heart" aria-hidden="true"></i>&nbsp;<a class="product-detail-wishlist" style="cursor: pointer;"
                                      onclick="addToWishList(<?php echo $this->item->id; ?>, '<?php echo EshopHelper::getSiteUrl(); ?>', '<?php echo EshopHelper::getAttachedLangLink(); ?>')"><?php echo JText::_('ESHOP_ADD_TO_WISH_LIST'); ?></a>
                                </div>
                                <?php
                            }
                            if (EshopHelper::getConfigValue('allow_compare')) {
                                ?>
                                <p><a style="cursor: pointer;"
                                      onclick="addToCompare(<?php echo $this->item->id; ?>, '<?php echo EshopHelper::getSiteUrl(); ?>', '<?php echo EshopHelper::getAttachedLangLink(); ?>')"><?php echo JText::_('ESHOP_ADD_TO_COMPARE'); ?></a>
                                </p>
                                <?php
                            }
                            if (EshopHelper::getConfigValue('allow_ask_question')) {
                                ?>
                                <p><a style="cursor: pointer;"
                                      onclick="askQuestion(<?php echo $this->item->id; ?>, '<?php echo EshopHelper::getSiteUrl(); ?>', '<?php echo EshopHelper::getAttachedLangLink(); ?>')"><?php echo JText::_('ESHOP_ASK_QUESTION'); ?></a>
                                </p>
                                <?php
                            }
                            if (EshopHelper::getConfigValue('allow_email_to_a_friend')) {
                                ?>
                                <p><a style="cursor: pointer;"
                                      onclick="emailAFriend(<?php echo $this->item->id; ?>, '<?php echo EshopHelper::getSiteUrl(); ?>', '<?php echo EshopHelper::getAttachedLangLink(); ?>')"><?php echo JText::_('ESHOP_EMAIL_A_FRIEND'); ?></a>
                                </p>
                                <?php
                            }
                            if (EshopHelper::getConfigValue('allow_download_pdf_product')) {
                                ?>
                                <p><a style="cursor: pointer;"
                                      href="index.php?option=com_eshop&task=product.downloadPDF&product_id=<?php echo $this->item->id; ?>"><?php echo JText::_('ESHOP_DOWNLOAD_PDF_PRODUCT'); ?></a>
                                </p>
                                <?php
                            }
                            ?>
                    ...
                    ?>
                    <div class="commit">
                        <div><i class="fa fa-check-circle-o"></i>&nbsp;&nbsp;<p>Cam kết chất lượng, không hài lòng trả
                                hàng!</p></div>
                        <div><i class="fa fa-truck"></i>&nbsp;&nbsp;<p>Giao hàng đúng hẹn</p></div>
                        <div><i class="fa fa-bookmark"></i>&nbsp;&nbsp;<p>Được tích điểm giảm giá</p></div>
                    </div>
                <?php endif; ?>
                <br>
                <?php
                if (EshopHelper::getConfigValue('allow_reviews')) {
                    ...
                    <div class="product-review">
                        <p>
                            ...
                            <a onclick="activeReviewsTab();"
                               style="cursor: pointer;"><?php echo count($this->productReviews) . ' ' . JText::_('ESHOP_REVIEWS'); ?></a>
                            | <a onclick="activeReviewsTab();"
                                 style="cursor: pointer;"><?php echo JText::_('ESHOP_WRITE_A_REVIEW'); ?></a>
                        </p>
                    </div>
                    <?php
                }
                        ...
                        <div class="product-share">
                            <div class="ps_area clearfix">
                                ...
                                if (EshopHelper::getConfigValue('show_facebook_button')) {
                                    ...
                                    <div class="ps_facebook_like">
                                        <div class="fb-like" data-send="true"
                                             data-width="<?php echo EshopHelper::getConfigValue('button_width', 450); ?>"
                                             data-show-faces="<?php echo EshopHelper::getConfigValue('show_faces', 1); ?>"
                                             vdata-font="<?php echo EshopHelper::getConfigValue('button_font', 'arial'); ?>"
                                             data-colorscheme="<?php echo EshopHelper::getConfigValue('button_theme', 'light'); ?>"
                                             layout="<?php echo EshopHelper::getConfigValue('button_layout', 'button_count'); ?>"></div>
                                    </div>
                                    <?php
                                }
                                if (EshopHelper::getConfigValue('show_twitter_button')) {
                                    ...
                                    <div class="ps_twitter">
                                        <a href="https://twitter.com/share" class="twitter-share-button"
                                           data-url="<?php echo $uri->toString(); ?>" tw:via="ontwiik" data-lang="en"
                                           data-related="anywhereTheJavascriptAPI" data-count="horizontal">Tweet</a>
                                    </div>
                                    <?php
                                }
                                if (EshopHelper::getConfigValue('show_pinit_button')) {
                                    ?>
                                    <div class="ps_pinit">
                                        <a href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode($uri->toString()); ?>&media=<?php echo urlencode(EshopHelper::getSiteUrl() . $this->item->thumb_image); ?>&description=<?php echo $this->item->product_name; ?>"
                                    ...
                                    <div class="ps_linkedin">
                                        ...
                                        ?>
                                            <script type="IN/Share"
                                                    data-counter="<?php echo EshopHelper::getConfigValue('linkedin_layout', 'right'); ?>"></script>
                                            <?php
                                        }
                                        ?>
                                    </div>
            ...
            <?php /*
                <div class="<?php echo $span3Class; ?>">
                    <?php echo JHtml::_('content.prepare', '{loadposition detail_position}'); ?>
                </div>
            */ ?>
        </div>
        <?php
        ...
        if (EshopHelper::getConfigValue('allow_reviews')) {
            ...
            if (count($this->productReviews) > 5) {
                ?>
                <div class="<?php echo $span12Class; ?> pagination pagination-toolbar"
                ...
                if (count($this->productReviews)) {
                    foreach ($this->productReviews as $review) {
                        ...
                        <div class="review-list">
                            <div class="author">
                                <b><?php echo $review->author; ?></b> <?php echo JText::_('ESHOP_REVIEW_ON'); ?> <?php echo JHtml::date($review->created_date, EshopHelper::getConfigValue('date_format', 'm-d-Y') . ' h:i A', null); ?>
                            </div>
                            <div class="rating"><img
                                        src="components/com_eshop/assets/images/stars-<?php echo $review->rating . '.png'; ?>"
                                        alt=""/></div>
            ...
            <div class="<?php echo $controlGroupClass; ?>">
                <label class="<?php echo $controlLabelClass; ?>" for="author"><span
                            class="required">*</span><?php echo JText::_('ESHOP_YOUR_NAME'); ?>:</label>
            ...
            <div class="<?php echo $controlGroupClass; ?>">
                <label class="<?php echo $controlLabelClass; ?>" for="author"><span
                            class="required">*</span><?php echo JText::_('ESHOP_YOUR_REVIEW'); ?>:</label>
                <div class="<?php echo $controlsClass; ?> docs-input-sizes">
            ...
            <div class="<?php echo $controlGroupClass; ?>">
                <label class="<?php echo $controlLabelClass; ?>" for="author"><span
                            class="required">*</span><?php echo JText::_('ESHOP_RATING'); ?>:</label>
                <div class="<?php echo $controlsClass; ?> docs-input-sizes">
            ...
            ?>
            <input type="button" class="<?php echo $btnClass; ?> btn-primary <?php echo $pullLeftClass; ?>"
                   id="button-review" value="<?php echo JText::_('ESHOP_SUBMIT'); ?>"/>
            ...
            if (EshopHelper::getConfigValue('show_facebook_comment')) {
                ...
                <div class="row-fluild">
                    ...
                    <div class="fb-comments"
                         data-num-posts="<?php echo EshopHelper::getConfigValue('num_posts', 10); ?>"
                         data-width="<?php echo EshopHelper::getConfigValue('comment_width', 400); ?>"
                         data-href="<?php echo $uri->toString(); ?>"></div>
                </div>
                <?php
            }
            echo JHtml::_('bootstrap.endTab');
        ...
        ?>
        <?php $products = EshopHelper::getCategoryProducts($categoryId, true);
        if (count($products) > 1) {
            ?>
            <div id="productRelate">
                <h2><?php echo JText::_('ESHOP_RELATED_PRODUCTS', true) ?></h2>
                <div>
                    <div class="list-product row">
                        ...
                        foreach ($products as $k => $product) {
                            ...
                            if ($product->product_image && JFile::exists(JPATH_ROOT . '/media/com_eshop/products/' . $product->product_image)) {
                                $image = call_user_func_array(array('EshopHelper', $imageSizeFunction), array($product->product_image, JPATH_ROOT . '/media/com_eshop/products/', 300, 300));
                            } else {
                                $image = call_user_func_array(array('EshopHelper', $imageSizeFunction), array('no-image.png', JPATH_ROOT . '/media/com_eshop/products/', 300, 300));
                            }
                            ...
                            if ($product->id != $this->item->id) {
                                ?>
                                <div class="eshop_product col-xs-6 col-sm-6 col-md-3 col-lg-3">
                                    <div class="item-product">
                                        <a href="<?php echo $viewProductUrl; ?>" class="product-img-wrap">
                                            <?php
										...
										<?php echo $label->label_name; ?>
                                            ...
                                            ?>
                                            <img class="product-item" alt="<?php echo $product->product_name; ?>"
                                                 src="<?php echo $image; ?>">
                                            <span class="feature_group group_<?= $product->p_group ?>"></span>
                                        </a>
                                        <a class="product-tile" href="<?php echo $viewProductUrl; ?>">
                                        ...
                                        <div class="eshop-buttons">
                                            ...
                                            if (EshopHelper::isCartMode($product)) {
                                                ...
                                                <div class="eshop-cart-area">
                                                    <button id="add-to-cart-<?php echo $product->id; ?>" type="button"
                                                        ...
                                                        <i class="fa fa-shopping-cart"></i>
                                                        <span class="txt txt-cart"><?php echo JText::_('ESHOP_ADD_TO_CART'); ?></span>
                                                    </button>
                                                </div>
                                                <?php
                                            }
                                        ...
                                        <div class="eshop-product-price">
                                            ...
                                            if (EshopHelper::showPrice() && !$product->product_call_for_price) {
                                                ...
                                                if ($productPriceArray['salePrice'] >= 0) {
                                                    ?>
                                                    <span class="eshop-base-price"><?php echo $this->currency->format($this->tax->calculate($productPriceArray['basePrice'], $product->product_taxclass_id, EshopHelper::getConfigValue('tax'))); ?></span>&nbsp;
                                                    <span class="eshop-sale-price"><?php echo $this->currency->format($this->tax->calculate($productPriceArray['salePrice'], $product->product_taxclass_id, EshopHelper::getConfigValue('tax'))); ?></span>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <span class="price"><?php echo $this->currency->format($this->tax->calculate($productPriceArray['basePrice'], $product->product_taxclass_id, EshopHelper::getConfigValue('tax'))); ?><span class="weight"> /  <?php  echo EshopHelper::getWeightUnitName($product->product_weight_id, JFactory::getLanguage()->getTag()) ; ?></span></span>
                                                    <?php
                                                }
                                                if (EshopHelper::getConfigValue('tax') && EshopHelper::getConfigValue('display_ex_tax')) {
                                                    ?>
...
if (count($this->productOptions)) {
    ?>
    <script type="text/javascript"
            src="<?php echo JUri::base(true); ?>/components/com_eshop/assets/js/ajaxupload.js"></script>
    <?php
