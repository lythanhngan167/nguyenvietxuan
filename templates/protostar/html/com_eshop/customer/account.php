...
?>
<div class="customer-box account_page">
    <div class="customer-box__content">
        <div class="customer-box__head">
            <h1 class="customer-box__head--title"><?php echo JText::_('ESHOP_MY_ACCOUNT'); ?></h1>
        </div>
        <form id="adminForm" action="<?php echo  str_replace('amp;','',JRoute::_('index.php?option=com_eshop&task=customer.processUser')); ?>" class="form-horizontal" method="post">
            <div id="process-user">
                ...
                <?php if (EshopHelper::isFieldPublished('lastname') && isset($this->userInfo->lastname)) : ?>
                    <div class="<?php echo $controlGroupClass; ?>">
                ...
                <div class="<?php echo $controlGroupClass; ?>">
                    ...
                    <div class="<?php echo $controlsClass; ?> docs-input-sizes">
                        <input type="text" name="username"  readonly id="username" value="<?php echo htmlspecialchars($this->userInfo->username, ENT_COMPAT, 'UTF-8'); ?>">
                    </div>
                </div>
                <?php /*
            <div class="<?php echo $controlGroupClass; ?>">
        ...
        */ ?>
                <?php if (EshopHelper::isFieldPublished('email') && isset($this->userInfo->email)) : ?>
                    <div class="<?php echo $controlGroupClass; ?>">
                ...
                <?php endif; ?>
                <?php if (EshopHelper::isFieldPublished('telephone') && isset($this->userInfo->telephone)) : ?>
                    <div style="display:none;" class="<?php echo $controlGroupClass; ?>">
                ...
                <?php endif ; ?>
                <?php if (EshopHelper::isFieldPublished('fax') && isset($this->userInfo->fax)) : ?>
                    <div class="<?php echo $controlGroupClass; ?>">
            ...
            <?php /*
        <button type="button" id="button-back-user-infor" class="btn btn-default" ><?php echo JText::_('ESHOP_BACK'); ?></button>
    */?>
            <button type="button" id="button-user-infor" class="btn btn-success" ><?php echo JText::_('ESHOP_SAVE'); ?></button>
