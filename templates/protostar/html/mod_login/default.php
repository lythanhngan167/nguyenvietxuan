...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure', 0)); ?>" method="post" id="login-form" class="form-inline">
	...
	<?php
	 ...
	 ?>
	<div class="new-logo">
		<a class="logo-desktop" href="<?php echo JUri::root(); ?>">
									<img src="<?php echo JUri::root(); ?>/images/logo-balpha.png" alt="B-Alpha">
								</a>
	</div>
	<div class="userdata" style="display:none;">
	<a href="<?php echo JRoute::_('index.php?Itemid='.$itemid); ?>"><i class="fa fa-user-circle-o" aria-hidden="true"></i></a>
	<span class = "welcome-visiter">Xin chào khách</span>

	<div class="log-res">
	<span><a href="<?php echo JRoute::_('index.php?option=com_users&view=login'); ?>"><?php echo JText::_('MOD_LOGIN'); ?></a></span>&nbsp;&nbsp;
	<span><a href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>"><?php echo JText::_('MOD_LOGIN_REGISTER'); ?></a></span>
	</div>
