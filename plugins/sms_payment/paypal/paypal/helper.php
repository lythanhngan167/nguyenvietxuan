...
class plgSms_paymentPaypalHelper
{
	...
	*/
	public static function Storelog($name, $data)
	{
		...
		JLog::addLogger(
			array(
					// Sets file name
					'text_file' => 'com_sms.paypal.errors.php'
			),
	...
	public function validateIPN($data, $sandbox = false, $params, $componentName = 'digicom')
	{
		...
		$url              = plgSms_PayPaypalHelper::buildIPNPaymentUrl(true, $sandbox);
		$newData = array(
