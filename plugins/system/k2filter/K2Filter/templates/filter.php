...
<div id="k2Container" class="genericView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="k2filter-toolbox" style="margin: 20px 0;">
		...
		<select style="float: right; width: 100px;" name="flimit" class="limit-box" onChange="document.K2Filter<?php echo $moduleId; ?>.flimit.value=this.value; submit_form_<?php echo $moduleId; ?>();">
			<?php
				$limits = Array(5, 10, 15, 20, 30, 50, 100, 9999);
				$selected = JRequest::getInt('flimit');
			?>
			<option value=""><?php echo JText::_("Hiển thị"); ?></option>
			<?php foreach($limits as $limit) { ?>
			<option value="<?php echo $limit; ?>"<?php if ($selected == $limit) echo ' selected="selected"'; ?>><?php echo $limit == 9999 ? "Tất cả" : $limit; ?></option>
			<?php } ?>
		</select>
		<?php endif; ?>
		<div style="clear: both;"></div>
	...
	<div class="genericItemList">
		...
		<div class="genericItemView search-k2">
		  ...
		  <div class="genericItemBody">
			  ...
			  <div class="genericItemIntroText">
			  	<?php
					 ...
					 $item->introtext = substr($item->introtext, 0, 1000);
					 echo $item->introtext ."...";
					 ?>
			  </div>
			  <?php endif; ?>
