...
// Load custom.css
JHtml::_('stylesheet', 'custom.css', array('version' => time(), 'relative' => true));
...
foreach ($groups as $group)
{
		if($group == 8){
			...
			if($group == 10){
				$is = 'is_ad_landing_page';
			}
			if($group == 11){
				$is = 'is_ad_member_and_data';
			}
			if($group == 12){
				$is = 'is_accountant';
			}
...
switch ($is) {
	case 'is_supper_admin':
		JHtml::_('stylesheet', 'custom_superadmin.css', array('version' => time(), 'relative' => true));
		break;

	case 'is_admin':
		JHtml::_('stylesheet', 'custom_admin.css', array('version' => time(), 'relative' => true));
		break;

	case 'is_ad_landing_page':
		JHtml::_('stylesheet', 'custom_ad_landing_page.css', array('version' => time(), 'relative' => true));
		break;

	case 'is_ad_member_and_data':
		JHtml::_('stylesheet', 'custom_ad_member_and_data.css', array('version' => time(), 'relative' => true));
		break;

	case 'is_accountant':
		JHtml::_('stylesheet', 'custom_accountant.css', array('version' => time(), 'relative' => true));
		break;

	case 'is_merchant':
		JHtml::_('stylesheet', 'custom_merchant.css', array('version' => time(), 'relative' => true));
		break;

	case 'is_ad_article':
		JHtml::_('stylesheet', 'custom_ad_article.css', array('version' => time(), 'relative' => true));
		break;
	case 'is_sbdm':
		JHtml::_('stylesheet', 'custom_sbdm.css', array('version' => time(), 'relative' => true));
		break;
	default:
		// code...
		break;
...
if($is_supper_admin == 1){
	...
	if($is_admin == 1){
		...
		JHtml::_('stylesheet', 'custom_otheradmin.css', array('version' => time(), 'relative' => true));
	}
