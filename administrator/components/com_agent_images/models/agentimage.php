 ...
 * @since  1.6
 */
class Agent_imagesModelAgentimage extends \Joomla\CMS\MVC\Model\AdminModel
{
	/**
	 * @var      string    The prefix to use with controller messages.
	 * @since    1.6
	 */
	protected $text_prefix = 'COM_AGENT_IMAGES';

	/**
	 * @var   	string  	Alias to manage history control
	 * @since   3.2
	 */
	public $typeAlias = 'com_agent_images.agentimage';
	...
	public function getForm($data = array(), $loadData = true)
	{
            ...
            // Get the form.
            $form = $this->loadForm(
                    'com_agent_images.agentimage', 'agentimage',
                    array('control' => 'jform',
                            'load_data' => $loadData
                    )
            );
	...
	/**
	 * Method to duplicate an Agentimage
	 *
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_agent_images'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = Factory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__agent_images');
				$max             = $db->loadResult();
