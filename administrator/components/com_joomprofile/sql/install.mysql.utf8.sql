...
CREATE TABLE IF NOT EXISTS `#__joomprofile_usergroup_searchfields` (
  ...
  `field_id` int(11) NOT NULL,
  `ordering` int(11) NOT NULL,
  `showOnProfile` tinyint(1) NOT NULL DEFAULT '0', 
  PRIMARY KEY (`usergroup_searchfield_id`),
  INDEX `idx_usergroup_id` (`usergroup_id`),
  INDEX `idx_field_id` (`field_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

CREATE TABLE IF NOT EXISTS `#__joomprofile_usergroup`(
  `usergroup_id` int(11) NOT NULL,
  `params` text,
  PRIMARY KEY (`usergroup_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

CREATE TABLE IF NOT EXISTS `#__joomprofile_address` (
...
CREATE TABLE IF NOT EXISTS `#__joomprofile_content`(
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `content` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
