...
<?php endif; ?>
    ...
    <form action="<?php echo JRoute::_('index.php'); ?>" enctype="multipart/form-data" method="post" name="adminForm" id="adminForm">
        ...
        <div id="k2FormTopNav" class="k2Tabs">
            ...
            <?php if($this->showSendNotification): ?>
                <div class="k2ui-table-additional">
                        <div class="k2ui-field-label">
                            <label for="featured">Gửi thông báo khi lưu</label>
                        </div>
                        <div class="k2ui-field-value k2ui-button-set">
                            <?php echo $this->lists['send_notication']; ?>
                        </div>
                        <div class="k2ui-field-label">
                            <label for="featured">Trạng thái thông báo:</label>
                        </div>
                        <div class="k2ui-field-value k2ui-button-set">
                            <?php if($this->row->status_notication == 0): ?>
                                <span class="text-warning">Chưa gửi thông báo</span>
                            <?php else: ?>
                                <span class="text-success">Đã gửi thông báo</span>
                            <?php endif; ?>

                        </div>
                        <?php if($this->row->status_notication == 1): ?>
                        <div class="k2ui-field-label">
                            <label for="featured">Thành viên và ngày gửi thông báo:</label>
                        </div>
                        <div class="k2ui-field-value k2ui-button-set">
                            <?php echo $this->row->user_send_notification; ?> (<?php echo $this->row->date_send_notification; ?>)
                        </div>
                        <?php endif; ?>
                </div>
                <?php endif; ?>
                ...
                <div class="k2ui-table-additional" <?php if ($this->lists['groups'] == 4): ?> style="display:none;" class="k2ui-table-additional-user"  <?php endif; ?>>
                    ...
                    <div class="k2ui-field-label">
                        <label for="featured"><?php echo JText::_('K2_TOP_ITEM'); ?></label>
                    </div>
                    <div class="k2ui-field-value k2ui-button-set">
                        <?php echo $this->lists['top_item']; ?>
                    </div>
                    <?php endif; ?>
                    <div class="k2ui-field-label">
                    ...
                    <div class="k2ui-field-value">
                        ...
                        <a data-k2-modal="iframe" id="k2SelectorEditor" class="k2Selector" href="index.php?option=com_k2&amp;view=users&amp;tmpl=component&amp;context=modalselector&amp;fid=k2Author&amp;fname=created_by">
                ...
                <div class="k2Tabs" id="k2Tabs">
                    ...
                    <?php if ($this->params->get('showImageGalleryTab')): ?>
                    <!-- Tab image gallery -->
                    <div class="k2TabsContent" id="k2TabImageGallery" <?php if ($this->lists['groups'] == 4): ?> style="display:none;"  <?php endif; ?>>
                    ...
                    <?php if ($this->params->get('showVideoTab')): ?>
                    <!-- Tab video -->
                    <div class="k2TabsContent" id="k2TabMedia" <?php if ($this->lists['groups'] == 4): ?> style="display:none;"  <?php endif; ?>>
                    ...
                    <?php if ($this->params->get('showExtraFieldsTab')): ?>
                    <!-- Tab extra fields -->
                    <div class="k2TabsContent" id="k2TabExtraFields" <?php if ($this->lists['groups'] == 4): ?> style="display:none;"  <?php endif; ?>>
