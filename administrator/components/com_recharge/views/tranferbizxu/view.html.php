 ...
 * @since  1.6
 */
class RechargeViewTranferbizxu extends JViewLegacy
{
	/**
	 * The item data.
	 *
	...
	public function display($tpl = null){
		...
		$this->users = $this->get('ListAgents');
		...
		if($_REQUEST['clear'] == 1){
			...
			$app->redirect('index.php?option=com_recharge&view=tranferbizxu&filter[search]=');
		}
		...
		JToolBarHelper::title("Chuyển BizXu giữa các Đai lý (TVV)");
