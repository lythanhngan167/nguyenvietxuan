...
<?php echo JText::_( 'VALUE' ); ?>: <?php echo number_format($this->conversion->value,0,".","."); ?><br />
<?php echo JText::_( 'COMISSION' ); ?>: <?php echo number_format($this->conversion->comission,0,".","."); ?><br />
...
<?php echo JText::_( 'VALUE' ); ?>: <?php echo number_format($this->conversion->value,0,".","."); ?><br />
<?php echo JText::_( 'COMISSION' ); ?>: <?php echonumber_format($this->conversion->comission,0,".","."); ?><br />
<?php echo JText::_( 'DATE_CREATED' ); ?>: <?php if($this->conversion->date_created == "0000-00-00 00:00:00") echo JText::_('NOT_SETTED'); else echo JHTML::_('date', $this->conversion->date_created, JText::_('DATE_FORMAT_LC3')); ?><br />
