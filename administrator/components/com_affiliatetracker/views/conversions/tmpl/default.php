  ...
  <div id="j-main-container" >
    ...
    $link_user    = JRoute::_( 'index.php?option=com_affiliatetracker&controller=conversions&user_id='. $row->owner_id );
      ...
      <tr class="<?php echo "row$k"; ?>">
        ...
        <td align="right" class=""><?php echo number_format($row->value,0,".","."); ?></td>
        <td align="right" class="hidden-phone"><?php echo number_format($row->comission,0,".","."); ?></td>
	...
	?>
      <tfoot>
        <tr class="totals">
          ...
          <td align="right" class="hidden-phone"><?php echo number_format($total_comission,0,".","."); ?></td>
          <td colspan="2" class="hidden-phone"></td>
        </tr>
        <tr>
