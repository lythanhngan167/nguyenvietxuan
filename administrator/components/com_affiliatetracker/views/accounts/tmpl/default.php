  ...
  <div id="j-main-container" >
    ...
    $link_user    = JRoute::_( 'index.php?option=com_affiliatetracker&controller=accounts&user_id='. $row->user_id );
      ...
      <tr class="<?php echo "row$k"; ?>">
        ...
        <td align="right" class="hidden-phone"><?php echo number_format($row->total_account,0,".","."); ?></td>
        <td align="right" class="hidden-phone"><?php echo number_format($row->total_earned,0,".","."); ?></td>
        <td align="right" class="hidden-phone"><?php echo number_format($row->total_paid,0,".","."); ?></td>
        <td align="right" class="hidden-phone"><?php echo number_format($total_owed,0,".","."); ?></td>

        <td class="hidden-phone">
          <?php if($total_owed > 0){ ?>
          <a href="<?php echo $link_payment; ?>" class="btn btn-mini"><?php echo JText::sprintf('CREATE_PAYMENT_X', number_format($total_owed,0,".",".")); ?></a>
          <?php } ?>
        </td>
      </tr>
      <?php
