...
<form action="<?php echo JRoute::_('index.php?option=com_sms&view=exams');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped">
		<thead>
			<tr>
				...
				<th width="25%" class="nowrap left"><?php echo JText::_('LABEL_EXAM_NAME'); ?></th>
				<th width="25%" class="center" class="nowrap left"><?php echo JText::_('LABEL_EXAM_DATE'); ?></th>
		...
		<tbody>
		    ...
		    $link 		= JRoute::_( 'index.php?option=com_sms&view=exams&task=editexam&cid[]='. $item->id );
		    ?>
			<tr class="row<?php echo $i % 2; ?>">
				<td class="left"><?php echo $checked; ?></td>
				<td class="left"><a href="<?php echo $link; ?>"><?php echo $item->name;?></a></td>
				<td class="center"><?php echo $item->examdate;?></td>
