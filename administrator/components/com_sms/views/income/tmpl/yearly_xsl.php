...
$objPHPExcel->getProperties()->setCreator($schools_name)
						 ...
						 ->setTitle("Office 2007 XLSX ".JText::_('LABEL_INCOME_YEAR_LIST')." ")
						 ->setSubject("Office 2007 XLSX ".JText::_('LABEL_INCOME_YEAR_LIST')."")
						 ->setDescription("".JText::_('LABEL_INCOME_YEAR_LIST')." for Office 2007 XLSX, generated using PHP classes.")
						 ->setKeywords("office 2007 openxml php")
						 ->setCategory(JText::_('LABEL_INCOME_YEAR_LIST'));

// Add some data
$objPHPExcel->setActiveSheetIndex(0)
        ->setCellValue('A1', '#')->setCellValue('B1', JText::_('LABEL_INCOME_YEAR'))
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Yearly Income List');
...
header('Content-Disposition: attachment;filename="yearly_income_list.xlsx"');
