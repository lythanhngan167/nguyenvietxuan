...
<form action="<?php echo JRoute::_('index.php?option=com_sms&view=sections');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped">
		<thead>
			<tr>
				...
				<th  class="nowrap left"><?php echo JText::_('LABEL_SECTION_NAME'); ?></th>
		...
		<tbody>
		  <?php foreach ($this->items as $i => $item) :
		    ...
		    $link 		= JRoute::_( 'index.php?option=com_sms&view=sections&task=editsection&cid[]='. $item->id );
		    ?>
			<tr class="row<?php echo $i % 2; ?>">
				<td class="left"><?php echo $checked; ?></td>
				<td class="left"><a href="<?php echo $link; ?>"><?php echo $item->section_name;?></a></td>
