...
<form action="<?php echo JRoute::_('index.php?option=com_sms&view=incomemonth');?>" method="post" name="adminForm" id="adminForm">
 ...
 .information-div p {text-align: center;}
	...
	<?php 
        ...
        $header_con ='<p style="text-align: center;"><input type="button" id="print" onclick="printDiv('.$onclick_link.')" class="btn btn-small"  style="border: none;margin-left: 10px;" value="Print" /> </p>';
				...
				$header .= '<p>'.JText::_('LABEL_INCOME_MONTH_LIST').'</p>';
				$header .= $header_con;
				$header .= '</div>';
	...
	<table class="table table-striped" id="admin-table" align="center" style="width: 95%;">
		<thead>
			<tr>
				<th  class=" center">#</th>
				<th  class=" left"><?php echo JText::_('LABEL_INCOME_MONTH'); ?></th>
		...
		<tbody>
		  ...
		  ?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="left" style="color: green;"><?php echo $monthName;?> - <?php echo $year; ?></td>
				<td style="text-align: right;" ><?php echo SmsHelper::getCurrency($item->Total); ?></td>
