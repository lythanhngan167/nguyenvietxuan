...
defined('_JEXEC') or die;
  ...
  $objPHPExcel->getProperties()->setCreator($schools_name)
							 ...
							 ->setTitle("Office 2007 XLSX ".JText::_('LABEL_EXPENSE_MONTH_LIST')."")
							 ->setSubject("Office 2007 XLSX ".JText::_('LABEL_EXPENSE_MONTH_LIST')."")
							 ->setDescription("".JText::_('LABEL_EXPENSE_MONTH_LIST')." for Office 2007 XLSX, generated using PHP classes.")
							 ->setKeywords("office 2007 openxml php")
							 ->setCategory(JText::_('LABEL_EXPENSE_MONTH_LIST'));

  // Add some data
  $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', '#')
						->setCellValue('B1', JText::_('LABEL_EXPENSE_MONTH'))
            ->setCellValue('C1', JText::_('LABEL_EXPENSE_AMMOUNT'));
			      ...
			      $monthName = date("F", mktime(0, 0, 0, $month, 10)).' - '.$year;
					  $ammount = number_format($row->Total, 2).$schools_currency;
					  $final_total = number_format($total, 2).$schools_currency;
						        ...
						        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A'.$cn.'', $i);
										...
										$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B'.$total_row.'', JText::_('LABEL_EXPENSE_TOTAL').':');
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Monthly Expense List');
...
header('Content-Disposition: attachment;filename="monthly_expense_list_'.$year.'.xlsx"');
