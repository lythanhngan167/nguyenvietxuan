...
$objPHPExcel->getProperties()->setCreator($schools_name)
						...
						->setTitle("Office 2007 XLSX ".JText::_('LABEL_EXPENSE_YEAR_LIST')." ")
						->setSubject("Office 2007 XLSX ".JText::_('LABEL_EXPENSE_YEAR_LIST')."")
						->setDescription("Expense List for Office 2007 XLSX, generated using PHP classes.")
						->setKeywords("office 2007 openxml php")
						->setCategory(JText::_('LABEL_EXPENSE_YEAR_LIST'));

  // Add some data
  $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', '#')
			->setCellValue('B1', JText::_('LABEL_EXPENSE_YEAR'))
			...
			if (!empty($this->items)) :
				...
				foreach ($this->items as $i => $row) :
					...
					$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B'.$cn.'', $year);
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Yearly Expense List');
...
header('Content-Disposition: attachment;filename="yearly_expense_list.xlsx"');
