...
<form action="<?php echo JRoute::_('index.php?option=com_sms&view=manageacademicyear');?>" method="post" name="adminForm" id="adminForm">
	...
	<?php endif; ?>
		...
		<table class="table table-striped">
			...
			<tbody>
			    ...
			    $link 		= JRoute::_( 'index.php?option=com_sms&view=manageacademicyear&task=edityear&cid[]='. $item->id );
			    ?>
				<tr class="row<?php echo $i % 2; ?>">
					<td class="left"><?php echo $checked; ?></td>
					<td class="left"><a href="<?php echo $link; ?>"><?php echo $item->year;?></a></td>
