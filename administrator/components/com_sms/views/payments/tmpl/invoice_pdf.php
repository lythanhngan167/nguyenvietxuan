...
if(!empty($this->payment->uid)){$uid = $this->payment->uid;}else {$uid="";}
	...
	$style ='<style type="text/css"> #admin-table tr td {font-size: 12px;}</style>';
	...
	$header .='<tr>';
	$header .='<td style="text-align: left;border: 0px;" width="50%" > ';
	$header  .= '<h4 class="" >'.JText::_('LABEL_PAYMENT_INVOICE').': '.$invID.'</h4>';
	$header .='</td>';
	$header .='<td style="text-align: right;border: 0px;" width="50%" > ';
	...
	$bill_info .='<tr>';
	$bill_info .='<td style="text-align: left;border: 0px;" width="50%" > <b>'.JText::_('LABEL_PAYMENT_INVOICE_PAYMENT_TO').'</b> <br />';
	$bill_info .='<span>'.$schools_name.'</span> <br />';
	$bill_info .='<span>'.$schools_address.'</span> <br />';
	$bill_info .='<span>'.$schools_phone.'</span> <br />';
	$bill_info .='</td>';
	$bill_info .='<td style="text-align: right;border: 0px;" width="50%" > <b>'.JText::_('LABEL_PAYMENT_INVOICE_BILL_TO').'</b> <br />';
