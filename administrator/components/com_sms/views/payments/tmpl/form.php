...
<form action="<?php echo JRoute::_('index.php?option=com_sms&view=payments');?>" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">
	...
	<input type="hidden" name="student_section" value="<?php echo $student_section; ?>" />
