...
<form action="<?php echo JRoute::_('index.php?option=com_sms&view=expensecategory');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped">
		<thead>
			<tr>
				...
				<th class=" left"><?php echo JText::_('LABEL_EXPENSE_CATEGORY_NAME'); ?></th>
		...
		<tbody>
		    ...
		    $link 		= JRoute::_( 'index.php?option=com_sms&view=expensecategory&task=editexcat&cid[]='. $item->id );
		    ?>
