 ...
 * @since  1.6
 */
class ConfigsViewConfigs extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ConfigsHelper::addSubmenu('configs');
	...
	protected function addToolbar()
	{
		...
		$canDo = ConfigsHelper::getActions();

		JToolBarHelper::title(Text::_('COM_CONFIGS_TITLE_CONFIGS'), 'configs.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('configs.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
		...
		{
			JToolBarHelper::preferences('com_configs');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_configs&view=configs');
	}
