...
$document->addStyleSheet(Uri::root() . 'media/com_configs/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_configs&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<?php if (JFactory::getUser()->authorise('core.admin','configs')) : ?>
