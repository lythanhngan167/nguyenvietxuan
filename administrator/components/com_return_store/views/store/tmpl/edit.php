...
$document->addStyleSheet(JUri::root() . 'media/com_return_store/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_return_store&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="store-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_RETURN_STORE_TITLE_STORE', true)); ?>
		<div class="row-fluid">
