...
/**
 * View class for a list of Notification.
 *
 * @since  1.6
 */
class NotificationViewNotifications extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_NOTIFICATION_TITLE_NOTIFICATIONS'), 'notifications.png');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`category`' => JText::_('COM_NOTIFICATION_NOTIFICATIONS_CATEGORY'),
			'a.`title`' => JText::_('COM_NOTIFICATION_NOTIFICATIONS_TITLE'),
			'a.`message`' => JText::_('COM_NOTIFICATION_NOTIFICATIONS_MESSAGE'),
			'a.`view`' => JText::_('COM_NOTIFICATION_NOTIFICATIONS_VIEW'),
