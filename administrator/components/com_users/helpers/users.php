...
class UsersHelper
{
	...
	public static function addSubmenu($vName)
	{
		...
		if ($canDo->get('core.admin') && (int)$userGroup[0] != 15)
		{
			JHtmlSidebar::addEntry(
		...
		if (JComponentHelper::isEnabled('com_fields') && JComponentHelper::getParams('com_users')->get('custom_fields_enable', '1') && (int)$userGroup[0] != 15)
		{
			JHtmlSidebar::addEntry(
