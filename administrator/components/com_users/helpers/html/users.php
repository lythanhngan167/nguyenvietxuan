...
class JHtmlUsers
{
	 ...
	 * @since  3.0
	 */
	public static function blockLandingpage( $self = false)
	{
		if ($self)
		{
			$states = array(
				1 => array(
					'task'           => 'unblocklanding',
					'text'           => '',
					'active_title'   => 'COM_USERS_USER_FIELD_BLOCK_LANDINGPAGE_DESC',
					'inactive_title' => '',
					'tip'            => true,
				...
				0 => array(
					...
					'text'           => '',
					'active_title'   => '',
					'inactive_title' => 'COM_USERS_USERS_ERROR_CANNOT_BLOCK_LANDINGPAGE_SELF',
					'tip'            => true,
		...
		else
		{
			$states = array(
				1 => array(
					'task'           => 'unblocklanding',
					'text'           => '',
					'active_title'   => 'COM_USERS_TOOLBAR_UNBLOCKLANDING',
					'inactive_title' => '',
					'tip'            => true,
					'active_class'   => 'unpublish',
					'inactive_class' => 'unpublish',
