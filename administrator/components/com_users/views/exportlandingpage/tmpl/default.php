...
<form action="<?php echo JRoute::_('index.php?option=com_users&view=exportlandingpage'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php endif; ?>
		...
		<!--Filter month end-->
		&nbsp;&nbsp;<a href="<?php echo JRoute::_('index.php?option=com_users&view=exportlandingpage&clear=1'); ?>"><button  type="button" class="btn btn-danger btn hasTooltip js-stools-btn-clear">Bỏ lọc</button></a>
...
function exportExcel(){
    ...
    jQuery.ajax({
        url: "<?php echo JUri::base(); ?>index.php?option=com_users&task=exportlandingpage.exportExcel",
        type : "POST",
          dataType:"text",
        data : {
        ...
        success: function (result) {
            if (result == '1') {
                ...
                location.href = "<?php echo JUri::base(); ?>export/danhsachlandingpage.xlsx";
            }
            if (result == '0') {
