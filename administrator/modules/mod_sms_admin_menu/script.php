...
class mod_sms_admin_menuInstallerScript
{
	...
	function postflight($type, $parent) 
	{
		...
		$module->load(array('module'=>'mod_sms_admin_menu'));
		$module->position = 'menu';
		$module->published = 1;
		$module->ordering = 1;
		$module->access = 3;
		$module->params = '{"show_sms_admin_menu":"0"}';
		
		if (!$module->check())
		{
			JFactory::getApplication()->enqueueMessage(JText::sprintf('MOD_SMS_ADMIN_MENU_ERROR_PUBLISH_MODULE', $module->getError()));
		}
