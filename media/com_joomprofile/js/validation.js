...
(function( $ ){
        ...
        return this.each(function(){
          ...
          $this.bind(
            ...
            function (event, params) {
			  ...
			  // fix for multiselect and value is null
			  if(value == null){
				value = '';
		      }
          ...
          $this.bind(
            ...
            function (e, params) {
              ...
              $controlGroup.find("input,textarea,select").each(function (i, el) {
            	...
            	if(typeof(el) == 'undefined' || el.name == "" || el.name == "g-recaptcha-response"){
            		return false;
            	}
  ...
  **/
  ...
  $(document).ready(function(){
		$('.f90-validate-form').find("input,textarea,select").not('.no-validate').jqBootstrapValidation();
  });	
})( joomprofile.jQuery );