...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
    ...
    foreach ($this->item->extra_fields as $key => $extraField):
      if($extraField->id == 25){
        $the_insured = $extraField->value;
      }
      if($extraField->id == 26){
        $duration_insurance = $extraField->value;
      }
      if($extraField->id == 27){
        $insurance_benefits_intro = $extraField->value;
      }
      if ($extraField->id == 28){
          $insurance_benefits_details = $extraField->value;
      }
      if($extraField->id == 29){
      ...
      if($extraField->id == 31){
          $support_travel = $extraField->value;
      }
    endforeach;
    ?>
    ...
    <div class="insurance-company">
        ...
        <div class="catItemImageBlock">
            <!-- <span class="catItemMoney"><?php echo $item_money; ?></span> -->
        ...
        <div class="insurance-title">
            ...
            <div class="logo"><?php echo $item_logo; ?></div>
            </div> -->

            <!-- <div class="time-and-money"><?php echo $item_time_and_money; ?></div> -->
    ...
    <div class="travel-the-insured">
        <div class="the-isured"><?php echo $the_insured; ?></div>
        <div class="the-isured-mobile"><div class="text-insured">Đối tượng BHDL</div> <div class="text-value"><?php echo $the_insured; ?></div></div>
    </div>
    <div class="duration-insurance">
        <?php echo $duration_insurance; ?>
    </div>
    <div class="duration-insurance-mobile">
        <div class="text-duration">Thời hạn BH</div> <div class="value-duration"><?php echo $duration_insurance; ?></div>
    </div>
    <div class="travel-insurance-benefits">
        <div class="insurance-benefits-intro">
              <?php echo $insurance_benefits_intro ?>
        </div>
        <div class="insurance-benefits-intro-mobile">
            <div class="text-benefits">Quyền lợi bảo hiểm</div> <div class="value-benefits"><?php echo $insurance_benefits_intro ?></div>
        </div>
        <div class="icon-benefits-intro" data-toggle="modal" data-target="#myModal-<?php echo $this->item->id; ?>">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Quyền lợi bảo hiểm</h4>
              </div>
              <div class="modal-body">
                  <?php echo $insurance_benefits_details ?>
                  <?php if ($insurance_benefits_details == ""): ?>
                    <script>
                       jQuery(".icon-benefits-intro").hide();
                    </script>
                   <?php endif; ?>
              </div>
            </div>
        ...
        <!-- <div class="insurance-benefits-ditails">
            <?php echo $insurance_benefits_details ?>
        </div> -->
    </div>
    <div class="travel-insurance-fees">
        ...
        <div class="insurance-fees-intro-mobile">
              <div class="text-fees">Phí bảo hiểm</div> <div class="value-fees"><?php echo $insurance_fees_intro; ?></div>
        </div>
        <div class="icon-fees-intro" data-toggle="modal" data-target="#myModalfees-<?php echo $this->item->id; ?>">
                <i class="fa fa-angle-down"></i>
        </div>
