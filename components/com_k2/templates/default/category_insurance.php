...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
    ...
    foreach ($this->item->extra_fields as $key => $extraField):
      if($extraField->id == 5){
        $item_logo = $extraField->value;
      }
      if($extraField->id == 6){
        $item_money = $extraField->value;
      }
      if($extraField->id == 7){
        $item_time_and_money = $extraField->value;
      }
    endforeach;
    ?>
    ...
    <div class="catItemHeader">
        ...
        <div class="logo-title">
            <div class="logo">
                <?php if( $item_logo == ''): ?>
                    <img src="<?php echo JURI::root().'images/logo-default.jpg'; ?>" alt="logo">
                <?php else: ?>
                    <?php echo $item_logo; ?>
                <?php endif; ?>
    ...
    <div class="catItemReadMore">
      <div class="button_bot">
  			<span id="registration"><a href="<?php echo LANDINGPAGE_LINK; ?>" target="_blank">Đăng ký tư vấn</a></span>
