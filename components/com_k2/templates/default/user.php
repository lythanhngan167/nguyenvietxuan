...
<div id="k2Container" class="userView<?php if ($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
    ...
    <?php endif; ?>
    <?php
    $userSession = JFactory::getUser();
    $groups = JAccess::getGroupsByUser($userSession->id, false);
    $group_id = $groups[0];
    if($group_id == 4 && $_REQUEST['Itemid'] == 491){
      echo '
      <fieldset id="users-profile-core">
	<legend>
		Danh sách Bài đã viết</legend>
    </fieldset>';
    }
    ?>
    ...
    <div class="userBlock">
        ...
        <img src="<?php echo $this->user->avatar; ?>" alt="<?php echo htmlspecialchars($this->user->name, ENT_QUOTES, 'UTF-8'); ?>" style="width:<?php echo $this->params->get('userImageWidth'); ?>px; height:auto;" onerror="if (this.src != 'error.jpg') this.src = '<?php echo JURI::root().'images/avatark2/avatardefault.png' ?>'" />
        <?php endif; ?>
        ...
        <div class="userItemView<?php if (!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
            ...
            <div class="userItemHeader">
                ...
                <h3 class="userItemTitle">
                    ...
                    <span class="userItemEditLink">
                        <a class="editItem" data-k2-modal="edit" href="<?php echo $item->editLink; ?>">
                    ...
                    <span class="item-unpublished">
                        <sup class="item-sup-unpublished">
                ...
                <?php if (!$item->published): ?>
                <span class="userItemEditLink">
                    <a class="previewItem" data-k2-modal="preview" href="<?php echo $item->link; ?>?preview=1">
                        Xem trước
                    </a>
                </span>
                <?php endif; ?>
            ...
            <div class="userItemBody">
                ...
                <div class="userItemIntroText">
                    ...
                    echo mb_substr($introText,0,500, "utf-8");
                    if(strlen($introText) >= 500){
                      echo " ...";
                    }
            ...
            <div class="userItemReadMore">
                <a class="k2ReadMore" href="<?php echo $item->link; ?><?php if (!$item->published) echo '?preview=1'; ?>">
