...
<form action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" name="userform" autocomplete="off" class="form-validate">
    ...
    <div id="k2Container" class="k2AccountPage">
        <table class="admintable w-100" cellpadding="0" cellspacing="0">
            <tr>
            ...
            <tr>
                <td class="key">
                    ...
                    <span class="k2-user-name-mobile"><b><?php echo $this->user->get('username'); ?></b></span>
                </td>
                <td class="k2-user-name">
            ...
            <tr>
                <td class="key">
                    ...
                    <input type="text" name="<?php echo $this->nameFieldName; ?>" id="name" size="40" value="<?php echo $this->escape($this->user->get( 'name' )); ?>" class="inputbox required k2-user-name-mobile" maxlength="50" />
                </td>
                <td class="k2-user-name">
            ...
            <tr>
                <td class="key">
                    ...
                    <input type="text" id="email" name="<?php echo $this->emailFieldName; ?>" size="40" value="<?php echo $this->escape($this->user->get( 'email' )); ?>" class="inputbox required validate-email k2-user-name-mobile" maxlength="100" />
                </td>
                <td class="k2-user-name">
            ...
            <tr>
                <td class="key">
                    ...
                    <input type="text" id="email2" name="jform[email2]" size="40" value="<?php echo $this->escape($this->user->get( 'email' )); ?>" class="inputbox required validate-email k2-user-name-mobile" maxlength="100" />
                </td>
                <td class="k2-user-name">
            ...
            <tr>
                <td class="key">
                    ...
                    <input class="inputbox validate-password k2-user-name-mobile" type="password" id="password" name="<?php echo $this->passwordFieldName; ?>" size="40" value="" />
                </td>
                <td class="k2-user-name">
            ...
            <tr>
                <td class="key">
                    ...
                    <input class="inputbox validate-passverify k2-user-name-mobile" type="password" id="password2" name="<?php echo $this->passwordVerifyFieldName; ?>" size="40" value="" />
                </td>
                <td class="k2-user-name">
            ...
            <tr>
                <td class="key">
                    ...
                    <textarea class="k2-user-name-mobile" id="description" name="description"><?php echo $this->K2User->description; ?></textarea>
                </td>
                <td class="k2-user-name">
                    <textarea class="w-100" id="description" name="description"><?php echo $this->K2User->description; ?></textarea>
            ...
            <tr>
                <td class="key">
                    <br>
                    <label id="imagemsg" for="image"><?php echo JText::_( 'K2_USER_IMAGE_AVATAR' ); ?><br>
                      Hình vuông 200x200 px
                      :
                    </label>
                    <div class="k2-user-name-mobile">
                        <input class="font-10" type="file" id="image" name="image" accept="image/*" />
                        ...
                        <label for="del_image" class="k2-text-file"><?php echo JText::_('K2_CHECK_THIS_BOX_TO_DELETE_CURRENT_IMAGE_OR_JUST_UPLOAD_A_NEW_IMAGE_TO_REPLACE_THE_EXISTING_ONE'); ?></label>
                        <?php endif; ?>
                    </div>
                </td>
                <td class="k2-user-name">
            ...
            <tr>
                <td class="key">
                    ...
                    <br>
                    <input class="k2-user-name-mobile" type="text" size="50" value="<?php echo $this->K2User->url; ?>" name="url" id="url" />
                </td>
                <td class="k2-user-name">
                    <br>
        ...
        <div class="k2AccountPageUpdate">
            <button class="button validate btn-save-profile" type="submit" onclick="submitbutton( this.form );return false;">
