 ...
 * @since  1.6
 */
class Agent_imagesModelAgentimage extends \Joomla\CMS\MVC\Model\ItemModel
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_agent_images')) && (!$user->authorise('core.edit', 'com_agent_images')))
		{
            ...
            if ($this->_item === null)
            {
                ...
                if ($table->load($id))
                {
                    ...
                    if ($published = $this->getState('filter.published'))
                    {
                        ...
                        {
                            throw new Exception(Text::_('COM_AGENT_IMAGES_ITEM_NOT_LOADED'), 403);
                        }
                    }
	...
	public function getItemIdByAlias($alias)
	{
            ...
            $result     = null;
            $aliasKey   = $this->getAliasFieldNameByView('agentimage');
