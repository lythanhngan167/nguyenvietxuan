    ...
    <?php else : ?>
        ...
        <form id="form-recharge"
            ...
            <div class="control-group">
            	...
            	Chọn gói<span class="star">&nbsp;*</span></label>
            </div>
                  ...
                  <label for="other">1.000.000 <?php echo BIZ_XU; ?> - <span class="billion">1 triệu <?php echo BIZ_XU; ?></span></label><br>
                  <input type="radio" onclick="changeMoneyTotal(this.value)" id="2billion" name="moneytotal" value="2000000">
                  <label for="other">2.000.000 <?php echo BIZ_XU; ?> - <span class="billion">2 triệu <?php echo BIZ_XU; ?></span></label><br>
                  <input type="radio" onclick="changeMoneyTotal(this.value)" id="3billion" name="moneytotal" value="3000000">
                  <label for="other">3.000.000 <?php echo BIZ_XU; ?> - <span class="billion">3 triệu <?php echo BIZ_XU; ?></span></label><br>
                  <input type="radio" onclick="changeMoneyTotal(this.value)" id="4billion" name="moneytotal" value="4000000">
                  <label for="other">4.000.000 <?php echo BIZ_XU; ?> - <span class="billion">4 triệu <?php echo BIZ_XU; ?></span></label><br>
                  <input type="radio" onclick="changeMoneyTotal(this.value)" id="5billion" name="moneytotal" value="5000000">
                  <label for="other">5.000.000 <?php echo BIZ_XU; ?> - <span class="billion">5 triệu <?php echo BIZ_XU; ?></span></label><br>
                  <input type="radio" onclick="changeMoneyTotal(this.value)" id="10billion" name="moneytotal" value="10000000">
                  <label for="other">10.000.000 <?php echo BIZ_XU; ?> - <span class="billion">10 triệu <?php echo BIZ_XU; ?></span></label>
                </div>
            </div>
...
function formRecharge(){
  ...
  jQuery('#btn-recharge').html('Đang xử lý...');
...
function changeMoneyTotal($money){
  // $after_money = '';
  // if($money == '1000000'){
  //   $after_money = '<b>1 triệu đồng</b>';
  // }
  // if($money == '2000000'){
  //   $after_money = '<b>2 triệu đồng</b>';
  // }
  // if($money == '3000000'){
  //   $after_money = '<b>3 triệu đồng</b>';
  // }
  // if($money == '4000000'){
  //   $after_money = '<b>4 triệu đồng</b>';
  // }
  // if($money == '5000000'){
  //   $after_money = '<b>5 triệu đồng</b>';
  // }
  // if($money == '10000000'){
  //   $after_money = '<b>10 triệu đồng</b>';
  // }
