 ...
 * @since  1.6
 */
class Request_packageRulesLegacy implements RulesInterface
{
    /**
    ...
    public function build(&$query, &$segments)
    {
        ...
        if (isset($query['id']))
        {
            ...
            if ($view !== null)
            {
				...
				if ($view == 'requestpackage')
				{
					$segments[] = $query['id'];
				}
				if ($view == 'requestpackages')
				{
					$segments[] = $query['id'];
				}
				if ($view == 'requestpackageform')
				{
					$segments[] = $query['id'];
				}
            }
    ...
    public function parse(&$segments, &$vars)
    {
        ...
        $model        = Request_packageHelpersRequest_package::getModel($vars['view']);
