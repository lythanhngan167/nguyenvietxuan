...
<?php
      ...
      echo $intro->text;
      ?>
<form action="<?php echo JRoute::_("index.php?option=com_affiliatetracker&view=account".$itemid); ?>" method="get" name="adminForm" id="adminForm" class="form-horizontal">
  ...
  <div class="table_scrolls">
      <table class="table table-striped logs_table items_table_responsive">
        ...
        switch($row->type){
            ...
            break;
            default:
                echo number_format($row->comission,0,".",".");
            break;
