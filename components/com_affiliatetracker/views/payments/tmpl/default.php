...
<div class="row-fluid ">
  <div class="span12 text-center">
    <div class="big_number"><?php echo number_format($this->payments,0,".","."); ?></div>
...
<table class="table table-striped logs_table">
  ...
  <tr class="<?php echo "row$k"; ?>">
    ...
    <td align="right" class="text-right"><?php echo number_format($row->payment_amount,0,".","."); ?></td>
  </tr>
  <?php
		$k = 1 - $k;
	}
  ...
  <tfoot>
    <tr class="totals">
      ...
      <td  class="hidden-phone"></td>
      <td align="right" class="text-right"><?php echo number_format($total_payments,0,".","."); ?></td>
    </tr>
