...
<form action="<?php echo JRoute::_("index.php?option=com_affiliatetracker&view=logs".$itemid); ?>" method="get" id="adminForm" name="adminForm"  class="navbar-form pull-left form-horizontal">
