...
<div class="page-header affiliate-area">
  <h2><?php echo JText::_('AFFILIATE_TITLE'); ?></h2>
</div>
...
<?php
      ...
      echo $intro->text;
      ?>
<div class="navbar form-fillter-conv">
<div class="navbar-inner content-form-fillter-conv">
...
?>
  ...
  <div class="row-fluid">
    ...
    <div class="span6 text-center">
      <div class="big_number"><?php echo number_format($this->comission_value,0,".","."); ?></div>
  ...
  <table class="table table-striped">
    ...
    <tr class="<?php echo "row$k"; ?>">
      ...
      <td align="right" class="text-right hidden-phone"><?php echo number_format($row->value,0,".","."); ?></td>
      <td align="right" class="text-right "><?php echo number_format($row->comission,0,".","."); ?></td>
    ...
    <tfoot>
      <tr class="totals">
        ...
        <td align="right " class="hidden-phone text-right"><?php echo number_format($total,0,".","."); ?></td>
        <td align="right" class="text-right"><?php echo number_format($total_comission,0,".","."); ?></td>
