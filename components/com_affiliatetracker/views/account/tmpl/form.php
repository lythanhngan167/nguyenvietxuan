...
?>
<div class="page-header affiliate-area">
  <h2><?php echo $this->account->id ? $this->account->account_name ." <small>[".JText::_('EDIT')."]</small>" : JText::_('REQUEST_NEW_AFFILIATE_ACCOUNT'); ?></h2>
</div>
...
<fieldset class="adminform" id="notLoggedUserSection">
    <div class="control-group">
        ...
        <div class="span6">
            ...
            <p><?php echo "Đăng ký khách hàng"; ?></p>
            <a href="index.php?Itemid=<?php echo PAGE_REGISTRATION_CUSTOMER; ?>">
              <button class="btn btn-primary" id="register-account-btn"><?php echo "Đăng ký"; ?></button>
            </a>
            <p><?php echo "Đăng ký Tư vấn viên"; ?></p>
            <a href="index.php?Itemid=<?php echo PAGE_REGISTRATION_AGENT; ?>">
              <button class="btn btn-primary" id="register-account-btn"><?php echo "Đăng ký"; ?></button>
            </a>
    ...
    <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="form-horizontal">
      ...
      <fieldset class="adminform">
        ...
        <div class=" form-actions">
          ...
          <a href="<?php echo JRoute::_('index.php?option=com_affiliatetracker&task=cancel'); ?>" class="btn "><i class="icon-cancel"></i> <?php echo JText::_('CANCEL'); ?></a>
        </div>
