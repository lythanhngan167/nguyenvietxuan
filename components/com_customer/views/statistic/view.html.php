 ...
 * @since  1.6
 */
class CustomerViewStatistic extends JViewLegacy
{
	protected $state;
	...
	public function getListCat(){
		$model = & $this->getModel('Statistic', 'CustomerModel');
	...
	public function getCountContactReturnCancel($userid,$status_id,$catid){
		$model = & $this->getModel('Statistic', 'CustomerModel');
		$counter = $model->getCountContactReturnCancel($userid,$status_id,$catid);
		return $counter;
	}
