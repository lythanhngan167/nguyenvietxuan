 ...
 * @since  1.6
 */
class Crm_configModelCrmconfig extends JModelItem
{
	/**
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_crm_config')) && (!$user->authorise('core.edit', 'com_crm_config')))
		{
		...
		if ($this->_item === null)
		{
			...
			if ($table->load($id))
			{
				...
				if ($published = $this->getState('filter.published'))
				{
					...
					{
						throw new Exception(JText::_('COM_CRM_CONFIG_ITEM_NOT_LOADED'), 403);
					}
				}
