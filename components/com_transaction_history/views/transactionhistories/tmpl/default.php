...
@media only screen and (max-width: 760px), (min-device-width: 768px) and (max-device-width: 1024px)  {
		...
		*/
        ...
        tbody td:nth-of-type(2):before { content: "Tiêu đề:"; }
        tbody td:nth-of-type(3):before { content: "Số BizXu:"; }
        tbody td:nth-of-type(4):before { content: "Ngày tạo:"; }
        tbody td:nth-of-type(5):before { content: "Loại Giao dịch:"; }
        tbody td:nth-of-type(6):before { content: "Trạng thái:"; }
        tbody td:nth-of-type(7):before { content: "Mã tham chiếu:"; }
