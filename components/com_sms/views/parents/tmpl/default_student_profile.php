...
defined('_JEXEC') or die;
    ...
    // Display Profile
    $display_profile = '<div class="avator profile" style="background: #f5f5f5;padding: 20px 0;"><img src="'.$img_src.'" alt="'.$name.'" width="150px" height="150px" /></div>';
	...
	$display_profile .= '<tr><td class="first" > '.JText::_('LABEL_STUDENT_NAME').': </td> <td class="secound">'.$name.'</td></tr>';
	$display_profile .= '<tr><td class="first" > '.JText::_('LABEL_STUDENT_ROLL').': </td> <td class="secound">'.$roll.'</td></tr>';
	$display_profile .= '<tr><td class="first" > '.JText::_('LABEL_STUDENT_CLASS').': </td> <td class="secound">'.SmsHelper::getClassname($class).'</td></tr>';
	$display_profile .= '<tr><td class="first" > '.JText::_('LABEL_STUDENT_SECTION').': </td> <td class="secound">'.SmsHelper::getSectionname($section).'</td></tr>';
	$display_profile .= '<tr><td class="first" > '.JText::_('LABEL_STUDENT_DIVISION').': </td> <td class="secound">'.SmsHelper::getDivisionname($division).'</td></tr>';
	$display_profile .= '<tr><td class="first" > '.JText::_('LABEL_STUDENT_YEAR').': </td> <td class="secound">'.SmsHelper::getAcademicYear($year).'</td></tr>';
