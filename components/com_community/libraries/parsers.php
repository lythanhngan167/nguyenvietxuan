            ...
            if (count($urls) > 0) {
                ...
                if($useDefault){
                    ...
                    // Everyhing else.
                        ...
                        $contentType = isset($response['info']['content_type']) ? strtolower($response['info']['content_type']) : '';

                        if ($contentType && preg_match('/windows-1251/', $contentType)) {
                            $response['raw'] = mb_convert_encoding($response['raw'], "UTF-8", "Windows-1251"); 
                            $data->body = mb_convert_encoding($data->body, "UTF-8", "Windows-1251"); 
