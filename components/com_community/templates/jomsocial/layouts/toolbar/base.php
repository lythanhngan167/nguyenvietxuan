...
<div class="joms-toolbar">
    <ul>
        ...
        <li id="noti-mobile-general-li">
            <a id="noti-mobile-general-a" class="joms-js--notification-general" data-ui-object="joms-dropdown-button" href="<?php echo CRoute::_('index.php?option=com_community&view=profile&task=notifications'); ?>">
                <svg viewBox="0 0 16 16" class="joms-icon">
        ...
        <li id="noti-mobile-friendrequest-li">
            <a id="noti-mobile-friendrequest-a" class="joms-js--notification-friendrequest" data-ui-object="joms-dropdown-button" href="<?php echo CRoute::_('index.php?option=com_community&view=friends&task=pending'); ?>">
                <svg viewBox="0 0 16 16" class="joms-icon">
        ...
        <li id="noti-mobile-chat-li" class="joms-js--notification-chat-list-mobile">
            <a id="noti-mobile-chat-a" class="joms-js--notification-chat" data-ui-object="joms-dropdown-button" onclick="javascript:;" href="<?php echo CRoute::_('index.php?option=com_community&view=chat'); ?>">
                <svg viewBox="0 0 16 16" class="joms-icon">
...
<div class="joms-toolbar--desktop">
    <ul>
        ...
        <?php } ?>
        <li id="noti-general-li">
            <a id="noti-general-a" class="joms-js--notification-general" data-ui-object="joms-dropdown-button" href="<?php echo CRoute::_('index.php?option=com_community&view=profile&task=notifications'); ?>">
                <svg viewBox="0 0 16 16" class="joms-icon">
                    <use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-earth"></use>
                </svg>
                <span class="joms-notifications__label joms-js--notiflabel-general"><?php echo $newEventInviteCount > 0 ? $newEventInviteCount : ''; ?></span>
        ...
        <li id="noti-friendrequest-li">
            <a id="noti-friendrequest-a" class="joms-js--notification-friendrequest" data-ui-object="joms-dropdown-button" href="<?php echo CRoute::_('index.php?option=com_community&view=friends&task=pending'); ?>">
                <svg viewBox="0 0 16 16" class="joms-icon">
                    <use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-users"></use>
                </svg>
                <span class="joms-notifications__label joms-js--notiflabel-frequest"><?php echo $newFriendInviteCount > 0 ? $newFriendInviteCount : ''; ?></span>
        ...
        <li class="joms-right">
            <a class="joms-js--logout" href="javascript:void(0);" onclick="document.getElementById('jomsocial-logout-form').submit();">
                <?php echo JText::_('COM_COMMUNITY_LOGOUT'); ?> <svg viewBox="0 0 16 16" class="joms-icon">
