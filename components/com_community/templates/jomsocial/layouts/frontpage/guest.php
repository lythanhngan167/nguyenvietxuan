        ...
        <div class="joms-landing__action <?php if(CSystemHelper::tfaEnabled()) { echo 'tfaenabled'; } ?>">
            <form class="joms-form joms-js-form--login" action="<?php echo CRoute::getURI(); ?>" method="post" name="login" id="form-login">
                <div class="joms-input--append">
                    ...
                    <input type="text" value="<?php if($_REQUEST['phone'] !=''){ echo $_REQUEST['phone']; } ?>" id="form-login-username" name="username" class="joms-input" placeholder="<?php echo JText::_('COM_COMMUNITY_USERNAME'); ?>">
                </div>
                <div class="joms-input--append">
                    <svg viewBox="0 0 16 16" class="joms-icon">
                ...
                <a class="remind-link" href="<?php echo CRoute::_('index.php?option=' . COM_USER_NAME . '&view=remind'); ?>"><?php echo JText::_('COM_COMMUNITY_FORGOT_USERNAME_LOGIN'); ?></a>
                <a class="reset-link" href="<?php echo CRoute::_('index.php?option=' . COM_USER_NAME . '&view=reset'); ?>"
