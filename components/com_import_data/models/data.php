 ...
 * @since  1.6
 */
class Import_dataModelData extends JModelItem
{
	/**
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_import_data')) && (!$user->authorise('core.edit', 'com_import_data')))
		{
		...
		if ($this->_item === null)
		{
			...
			if ($table->load($id))
			{
				...
				if ($published = $this->getState('filter.published'))
				{
					...
					{
						throw new Exception(JText::_('COM_IMPORT_DATA_ITEM_NOT_LOADED'), 403);
					}
				}
