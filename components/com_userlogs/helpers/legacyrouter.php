 ...
 * @since  1.6
 */
class UserlogsRulesLegacy implements RulesInterface
{
    /**
    ...
    public function build(&$query, &$segments)
    {
        ...
        if (isset($query['id']))
        {
            ...
            if ($view !== null)
            {
				...
				if ($view == 'userlogs')
				{
					$category = Categories::getInstance('userlogs.userlogs')->get($query['id']);
    ...
    public function parse(&$segments, &$vars)
    {
        ...
        $model        = UserlogsHelpersUserlogs::getModel($vars['view']);
        ...
        while (!empty($segments))
        {
            ...
            else
            {
				...
				if ($vars['view'] == 'userlogs')
				{
					$category = Categories::getInstance('userlogs.userlogs', array('access' => false))->get('root');
					if ($category)
					{
