 ...
 * @since  1.6
 */
class RegistrationModelRegistration extends \Joomla\CMS\MVC\Model\ItemModel
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_registration')) && (!$user->authorise('core.edit', 'com_registration')))
		{
	...
	public function getItem($id = null)
	{
            if ($this->_item === null)
            {
                ...
                if ($table->load($id))
                {
                    ...
                    if ($published = $this->getState('filter.published'))
                    {
                        ...
                        {
                            throw new Exception(Text::_('COM_REGISTRATION_ITEM_NOT_LOADED'), 403);
                        }
                    }
		...
		{
			$this->_item->province = JText::_('COM_REGISTRATION_REGISTRATIONS_PROVINCE_OPTION_' . $this->_item->province);
		}

		if (!empty($this->_item->status))
		{
			$this->_item->status = JText::_('COM_REGISTRATION_REGISTRATIONS_STATUS_OPTION_' . $this->_item->status);
		}
	...
	public function getItemIdByAlias($alias)
	{
            ...
            $result     = null;
            $aliasKey   = $this->getAliasFieldNameByView('registration');
